      ...
      <Card.Body>
        <blockquote className="blockquote mb-0">
          <p style={{ textAlign: "justify" }}>
            Hi Everyone, I am <span className="purple">Conticchio Giuseppe </span>
          ...
          <ul>
            <li className="about-activity">
              <ImPointRight className="about-icon"/> &nbsp; Playing Games <IoLogoGameControllerB className="about-icon"/>
            </li>
            <li className="about-activity">
              <ImPointRight className="about-icon"/> &nbsp; Playing Guitar, and other instrument <ImMusic className="about-icon"/>
            </li>
            <li className="about-activity">
